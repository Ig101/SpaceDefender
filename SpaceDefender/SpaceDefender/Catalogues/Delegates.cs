    ...
    static class Delegates
    {
        public static bool BlasterAttack(Scene scene, Module owner)
        {
            ...
            scene.Missles.Add(new Missle(scene, owner.AbsoluteX + (owner.Width / 2.5f * (direction ? 1 : -1)),
                owner.AbsoluteY, new Sprite("blasterMissle", 16, 16, 1, 2, 1, Color.White), 2, 3000, direction ? 0 : MathHelper.Pi, DefaultMoveRule, DefaultEnergyDamage,
                1, owner.Parent, null));
            return true;
        }
        ...
        public static bool RocketAttack(Scene scene, Module owner)
        {
            ...
            scene.Missles.Add(new Missle(scene, owner.AbsoluteX + (owner.Width / 2f * (direction ? 1 : -1)),
                owner.AbsoluteY, new Sprite("rocketMissle", 16, 16, 1, 2, 1, Color.White), 2, 2500, direction ? 0 : MathHelper.Pi, DefaultMoveRule, DefaultPhysicalDamage,
                1, owner.Parent, null));
            return true;
        }
        ...
        public static bool AnnihilatorAttack(Scene scene, Module owner)
        {
            ...
            scene.Missles.Add(new Missle(scene, owner.AbsoluteX + (owner.Width / 10f * (direction ? 1 : -1)),
                owner.AbsoluteY, new Sprite("anniMissle", 16, 16, 1, 2, 1, Color.White), 2, 1000, direction ? 0 : MathHelper.Pi, DefaultMoveRule, DefaultMagicDamage,
                5, owner.Parent, null));
            return true;
        }
        ...
        public static bool GenerateResource(Scene scene, Module owner)
        {
            ...
            scene.Effects.Add(new SpecEffect(scene, owner.AbsoluteX, owner.AbsoluteY, new Sprite("genEffect", 64, 64, 9, 2, 1, Color.White), 0.28f));
            return true;
        }
        ...
        {
            scene.Effects.Add(new SpecEffect(scene, x, y, new Sprite("explosion", 96, 96, 18, 2, 1, Color.White),0.55f));
        }
